        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm">
              Успішний результат у більш ніж 90% випадків. Ми єдина організація в Україні, яка допомагає повернути кошти з криптовалютної індустрії, бірж, платформ, шахрайських гаманців, банків, карткових операцій та інших фінансових випадків абсолютно безкоштовно.
            </p>
          </div>
